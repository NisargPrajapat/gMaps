  ...
  return (
    <div className="min-h-[calc(100vh-4rem)]">
      <div className="flex flex-col lg:flex-row gap-4">
        {/* Sidebar */}
        <div className="w-full lg:w-1/3 min-w-[300px] bg-white p-4 rounded-lg shadow overflow-y-auto">
        ...
        {/* Map Container */}
        <div className="flex-1 min-w-[300px] h-[400px] lg:h-[calc(100vh-4rem)] relative">
          {currentLocation && (
            <GoogleMap
