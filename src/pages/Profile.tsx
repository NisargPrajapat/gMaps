...
// import { User, Mail, Calendar, Edit, Save, X, MapPin, Phone } from 'lucide-react';
...
//             {profile.savedMaps.map((map, index) => (
...
//   const deleteMap = async (index: number) => {
//     try {
//       const token = localStorage.getItem('token');
//       if (!token) {
...
//       const response = await fetch(`http://localhost:5000/api/profile/delete-map/${index}`, {
//         method: 'DELETE',
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
